...
class DetectBirds(object):
    def __init__(self, camera_url, mx_num_birds = 3):
        ...
        self.birdsCascade = cv2.CascadeClassifier("F:\\ML Lab Project\\Bird Detection\\birds.xml")
        ...
        while self.running:
            ...
            if ret:
                ...
                for (x, y, w, h) in birds:
                    cv2.rectangle(frame, (x, y), (x+w, y+h), (100, 400, 100), 2)
...
if __name__ == "__main__":
    D = DetectBirds("F:\\ML Lab Project\\Bird Detection\\birds2.mp4")
    D.detect()
